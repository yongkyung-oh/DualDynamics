...
def preprocess_data(times, X, y, final_index, append_times, append_intensity):
    ...
    train_coeffs = torchcde.hermite_cubic_coefficients_with_backward_differences(train_X.cuda(), times.cuda())
    val_coeffs = torchcde.hermite_cubic_coefficients_with_backward_differences(val_X.cuda(), times.cuda())
    test_coeffs = torchcde.hermite_cubic_coefficients_with_backward_differences(test_X.cuda(), times.cuda())
