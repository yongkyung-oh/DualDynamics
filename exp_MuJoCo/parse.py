...
def parse_args():
    parser = argparse.ArgumentParser(description='MuJoCo')
    ...
    parser.add_argument('--hh_channels', type=int, default=64,help='Hidden Hidden Channels')          
    parser.add_argument('--layers', type=int, default=2,help='Num of Hidden Layers')   
